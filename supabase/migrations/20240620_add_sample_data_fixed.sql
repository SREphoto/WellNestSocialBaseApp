...
INSERT INTO public.users (id, full_name, avatar_url, created_at, updated_at, token_identifier, name)
VALUES
  ('00000000-0000-0000-0000-000000000001', 'Sarah Johnson', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah', NOW(), NOW(), 'token_sarah', 'Sarah Johnson'),
  ('00000000-0000-0000-0000-000000000002', 'Alex Chen', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Alex', NOW(), NOW(), 'token_alex', 'Alex Chen'),
  ('00000000-0000-0000-0000-000000000003', 'Jordan Smith', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jordan', NOW(), NOW(), 'token_jordan', 'Jordan Smith'),
  ('00000000-0000-0000-0000-000000000004', 'Taylor Williams', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Taylor', NOW(), NOW(), 'token_taylor', 'Taylor Williams'),
  ('00000000-0000-0000-0000-000000000005', 'Morgan Lee', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Morgan', NOW(), NOW(), 'token_morgan', 'Morgan Lee')
ON CONFLICT (id) DO NOTHING;
